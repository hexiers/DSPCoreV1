...
#pragma CODE_SECTION(InitFlash120MHz, "ramfuncs");
...
// HISPCP/LOSPCP prescale register settings, normally it will be set to default values
   ...
   SysCtrlRegs.LOSPCP.all = 0x0003;		//LSPCLK=SYSCLKOUT/6
